        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tastes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TasteTreatId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TasteId = table.Column<int>(type: "int", nullable: false),
                    TreatId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TasteTreat", x => x.TasteTreatId);
                    table.ForeignKey(
                        name: "FK_TasteTreat_Tastes_TasteId",
                        column: x => x.TasteId,
                        principalTable: "Tastes",
                        principalColumn: "TasteId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TasteTreat_Treats_TreatId",
                        column: x => x.TreatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TasteTreat_TasteId",
                table: "TasteTreat",
                column: "TasteId");

            migrationBuilder.CreateIndex(
                name: "IX_TasteTreat_TreatId",
                table: "TasteTreat",
                column: "TreatId");
